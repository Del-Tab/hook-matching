...
Sketch uses 14280 bytes (5%) of program storage space. Maximum is 253952 bytes.
Global variables use 455 bytes (5%) of dynamic memory, leaving 7737 bytes for local variables. Maximum is 8192 bytes.
